...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="mainNav">
    <a class="navbar-brand" href="<?php echo base_url(); ?>userhome">User Dashboard</a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="User Dashboard">
          <a class="nav-link" href="<?php echo base_url(); ?>userhome">
            <i class="fa fa-fw fa-dashboard"></i>
            <span class="nav-link-text">Dashboard</span>
          </a>
        </li>

        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Image News">
          <a class="nav-link" href="<?php echo base_url(); ?>contents">
            <i class="fa fa-fw fa-video-camera"></i>
            <span class="nav-link-text">Image News</span>
          </a>
        </li>

        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Video News">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="<?php echo base_url(); ?>userhome/logout">Logout</a>
          </div>
        </div>
      </div>
    </div>
