<div class="contain-fluid" align="center">
  <div class="col-md-12">
    <div class="card border-primary">
      <div class="card-header bg-primary text-white"> <i class="fa fa-table"></i> Add Member Offer</div>
      <div class="card-body">
        <form enctype="multipart/form-data" id="submit">
          <legend>Add Offer for member</legend>
...
$('#submit').submit(function(e){
  console.log("inside ajax submit");
    ...
    $("#loading").show();
         $.ajax({
             url:"<?php echo base_url();?>offers/do_upload",
             type:"post",
             ...
             async:false,
              success: function(data){
                ...
                $("#loading").hide();
                window.location.href = "<?php echo base_url().'offers' ?>";
           }
         });
    });
</script>