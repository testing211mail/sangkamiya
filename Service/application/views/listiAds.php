...
<div align="right">
    <a class="btn btn-primary" href="<?php echo base_url(); ?>imageads/addiad"><i class="fa fa-plus"></i> Add Advertisement</a>
</div>
<br>
<div class="col-md-12" align="center">
    <div class="card border-primary">
        <div class="card-header bg-primary text-white"> <i class="fa fa-table"></i> List Image Advertisements </div>
          <div class="card-body">
                        ...
                        <?php if (!empty($result)) {
                                foreach ($result as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td align="left">
                                            <a href="#" class="btn btn-danger btn-sm" data-toggle="modal" onclick="showdel(<?php echo $value->img_ad_id; ?>)"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                        </tbody>
                            <?php }}else{ ?>
...
function showdel(id)
  ...
  function deletead(id)
  {
    ...
    var url = "<?php echo base_url(); ?>imageads/deleteiad"; 
      $.ajax({
          type: "POST",
          url: url,         
          data: {'id':id},
