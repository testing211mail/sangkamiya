                            ...
                            <?php if (!empty($result)) { //print_r($result);exit();
                                foreach ($result as $key => $value) { ?>
                                    <tr>
                                        ...
                                        <td><?php echo $value->mem_name.",".$value->mem_mname; ?></td>
                                        ...
                                        <td align="left">
                                            <a href="<?php echo base_url(); ?>members/viewMember/<?php echo $value->mem_id ;?>" class="btn btn-info btn-sm" data-toggle="tooltip" data-original-title="View"><i class="fa fa-eye"></i></a>
                                            <a href="<?php echo base_url(); ?>members/editMember/<?php echo $value->mem_id ;?>" class="btn btn-warning btn-sm" data-toggle="tooltip" data-original-title="Edit"><i class="fa fa-pencil"></i></a>
                                            <a href="#" class="btn btn-danger btn-sm" data-toggle="modal" onclick="showdel(<?php echo $value->mem_id; ?>)"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                        </tbody>
...
$(document).ready(function() {
    ...
    // $('#memberTable').DataTable({"ordering": false,
