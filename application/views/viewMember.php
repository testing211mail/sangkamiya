                ...
                <div class="row">
                	...
                	<div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md">
                                <h4><?php echo $value->mem_mname; ?></h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md">
                            ...
                            <div class="col-md">
                                <h4><?php echo $value->mem_hname; ?></h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md">
                                <h4><?php echo $value->business_mname; ?></h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md">
                            ...
                            <div class="col-md">
                                <h4><?php echo $value->business_hname; ?></h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md">
                                <h4><?php echo $value->s_p_minfo; ?></h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md">
                            ...
                            <div class="col-md">
                                <h4><?php echo $value->s_p_hinfo; ?></h4>
                            </div>
                        </div>
