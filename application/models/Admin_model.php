...
class Admin_model extends CI_Model
{
    ...
    {
        $res = $this->db->query('SELECT ads.* , members.mem_name,members.business_name FROM ads join members on members.mem_id = ads.mem_id');
        $result = $res->result();
    ...
    public function editMember($formdata,$mid)
    {
        //print_r($formdata);exit();
        $this->db->where('mem_id',$mid);
    ...
    {
        $res = $this->db->query('SELECT offers.* , members.mem_name,members.business_name FROM offers join members on members.mem_id = offers.mem_id');
        $result = $res->result();
      ...
      public function getreport()
    {
      ...
      public function getallenquiry()
      {
        ...
        $res = $this->db->query('SELECT * FROM registration');
        $result = $res->result();
    ...
    {
        $res = $this->db->query('SELECT * FROM registration where reg_id='.$id);
        $result = $res->result();
...
//  $res = $this->db->query('SELECT offers.* , members.mem_name FROM offers join members on members.mem_id = offers.mem_id');
        $res = $this->db->query('SELECT enquiry.*,members.mem_name as memname FROM enquiry join members on members.mem_id = enquiry.mem_id');
        $result = $res->result();
