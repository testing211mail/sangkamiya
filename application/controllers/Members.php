...
class Members extends CI_Controller {
    ...
    public function editMember($id = '')
    {
        ...
        if (isset($formdata['task']) && $formdata['task'] == 'editMember') {
            ...
            $editarray = array('is_active'=> $formdata['is_active'], 'mem_name' => $formdata['mem_name'],'mem_mname' => $formdata['mem_mname'],'mem_hname' => $formdata['mem_hname'],'aadhar_no' => $formdata['aadhar_no'], 'blood_group' => $formdata['blood_group'],'business_name' => $formdata['business_name'],'business_mname' => $formdata['business_mname'],'business_hname' => $formdata['business_hname'], 's_p_info' => $formdata['s_p_info'],'s_p_minfo' => $formdata['s_p_minfo'],'s_p_hinfo' => $formdata['s_p_hinfo'], 'address' => $formdata['address'],'maddress' => $formdata['maddress'],'haddress' => $formdata['haddress'], 'lat' => $formdata['lat'], 'log' => $formdata['log'], 'mobile_no' => $formdata['mobile_no'], 'landline_no' => $formdata['landline_no'], 'email_id' => $formdata['email_id'],'website'=>$formdata['website'],'youtube'=>$formdata['youtube']);
            $result = $this->admin_model->editMember($editarray,$formdata['memid']);
